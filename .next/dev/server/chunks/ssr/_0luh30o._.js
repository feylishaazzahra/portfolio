...
const metadata = {
    ...
    description: "Creative design portfolio for Feylisha Azzahra, showcasing visual identities, social media assets, UI/UX work, photography interests, and freelance design experience.",
    keywords: [
        "Feylisha Azzahra",
        "creative designer",
        "graphic designer",
    ...
    authors: [
        {
            name: "Feylisha Azzahra"
        }
    ],
    openGraph: {
        title: "Feylisha Azzahra - Creative Design Portfolio",
        description: "Visual design, UI/UX concepts, social media assets, branding, print design, and event graphics.",
        type: "website"
    }
};
