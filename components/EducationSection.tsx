...
export default function EducationSection() {
  return (
    <section id="education" className="px-5 py-20 sm:px-8 lg:px-12">
      <SectionReveal className="relative mx-auto max-w-7xl overflow-hidden rounded-[2.25rem] border border-white/20 bg-violet-950 p-6 text-white shadow-[0_28px_90px_rgba(76,29,149,0.24)] sm:p-8 lg:p-10">
        ...
        <div className="grid gap-8 lg:grid-cols-[0.8fr_1.2fr] lg:items-end">
          ...
          <div className="liquid-glass-dark rounded-[1.5rem] p-5">
